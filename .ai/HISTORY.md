...
| P0-B exact-head CI delivery | Commit `6ead7992d4b1350edc8fb1a99c6955eea5d270cc`; Support Hub CI run `32129158353`; POS CI run `32129158321` | Explicitly installed npm 12.0.1 on the Node 24.18.0 runner. Support Hub RC generation, identity, sanitized safety, and packaged smoke passed; all applicable POS CI jobs passed at the same exact SHA. PR #24 remains open/draft/unmerged pending Opus re-review and Sol acceptance. |
