...
public class ContractTests
{
    ...
    public void OrderRequestRepository_DoesNotReferenceInventedColumns()
    {
        ...
        var sourcePath = Path.Combine(
            repoRoot, "backend", "src", "RmsSupportHub.Data", "Repositories", "OrderRequestRepository.cs");
    ...
    public void BackendSource_DoesNotReferenceStaleRmsHost()
    {
        ...
        var selfPath = Path.Combine(repoRoot, "backend", "tests", "RmsSupportHub.Tests", "ContractTests.cs");
