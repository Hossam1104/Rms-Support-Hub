...
| ADR-0022 | Accepted | RMS Branch/Cashier database recovery is a typed Agent-owned workflow with opaque artifacts and fail-closed outcome truth | POS Agent database backup/restore, SQL infrastructure, Support Hub maintenance | `.ai/decisions/ADR-0022-typed-rms-database-recovery.md` |
