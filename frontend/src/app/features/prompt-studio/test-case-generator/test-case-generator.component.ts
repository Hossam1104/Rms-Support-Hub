...
@Component({
  ...
  `,
    styles: [`
    .test-case-form { display: flex; flex-direction: column; gap: var(--panel-gap); }
    .test-case-form__section { display: flex; flex-direction: column; gap: var(--panel-gap); padding: var(--panel-padding-compact); border: 1px solid var(--border-subtle); border-radius: var(--radius-md); background: var(--surface-raised); }
    ...
    .test-case-form__grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--form-gap); }
