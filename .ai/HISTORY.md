...
| P0-B remediation implementation | Current working branch before final delivery | Added durable PR-head checkout/assertion, exact toolchain pins/manifest identity, real offline negative tests, exact URL allowances, sanitized Testing appsettings generation/verifier, artifact safety regression, release docs, and the bounded Opus re-review prompt. Final validation and exact-head CI remain to be recorded. |
