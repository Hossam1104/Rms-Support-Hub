...
@Component({
  ...
  styles: [`
    ...
    .dialog-header i { color: var(--danger); font-size: 1.3rem; }
    ...
    .quick-chip { background: var(--bg-tertiary); border: 1px solid var(--glass-border); border-radius: var(--radius-pill); color: var(--text-secondary); font-size: 0.76rem; padding: 4px 12px; cursor: pointer; }
    .quick-chip:hover { color: var(--text-primary); background: var(--glass-hover-bg); }
    ...
    .error-message.kind-blocked { background: var(--warning-bg); color: var(--warning); }
    .error-message.kind-upstream { background: var(--danger-bg); color: var(--danger); }
    .error-message.kind-network { background: var(--bg-tertiary); color: var(--text-secondary); }
