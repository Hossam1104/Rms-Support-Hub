...
| WPF-03 local RMS/Windows service health | Commit `e00447b`; Draft PR #34; exact-head CI green; strict Release build 0/0; POS tests 525/525; PowerShell 37/37; Pester 8/8 | Added the shared fixed-catalog service-health reader/handler, typed `rms.services.health` Local IPC operation, legacy HTTPS parity adapter, WPF Services workspace/Dashboard summary, bounded safe states, and deterministic coverage. Runtime frontend/backend probes and a responsive Release WPF process were verified. Service mutation remains deferred; GPT-5.6 Sol review remains the acceptance gate. |
