...
The feature branch is to be committed as logical backend, UI state, UI design,
and documentation changes; merged into local `main` with a no-fast-forward
merge; pushed to `origin/main`; and deleted after synchronization. No deploy.
